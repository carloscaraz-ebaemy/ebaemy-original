...
class Item extends ModelTenant
{
    ...
    protected $fillable = [
        ...
        'sale_unit_price',
        'purchase_unit_price',
        // Pricing rediseño Fase 1 (2026-05-18) — ver [[project_pricing_redesign]]
    ...
    protected $casts = [
        ...
        'floor_price_recalc_at'  => 'datetime',
        'favorite' => 'boolean',
 ...
 *
    ...
    public function getCollectionData(Configuration $configuration = null, $isRestaurant = false){
        ...
        return [
            ...
            'compare_at_from' => optional($this->compare_at_from)->format('Y-m-d'),
