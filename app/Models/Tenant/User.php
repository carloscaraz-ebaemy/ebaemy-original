...
'admin']);
     ...
     * @return bool
     */
    public function isFromGuestRegister()
    {
        return $this->from_guest_register;
    }
     ...
     * @return bool
     */
    public function isNotVerifiedUserEmail()
    {
        return $this->isFromGuestRegister() && !$this->hasVerifiedEmail();
    }
