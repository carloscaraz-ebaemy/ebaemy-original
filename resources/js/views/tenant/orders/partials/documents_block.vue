...
<script>
/**
 * El contenido del panel de documentos, sin envoltorio.
 *
 * Vive aparte porque tiene DOS hosts: el dialogo que abren los chips de la
 * tabla (`documents_panel.vue`) y el drawer de detalle, que lo empotra como un
 * bloque mas. Un dialogo dentro de un drawer se pisa con el fondo y se cierra
 * donde no toca, y clonar el panel daria dos verdades sobre que documentos
 * tiene un pedido — que es justo lo que este modulo lleva semanas corrigiendo.
 *
