        ...
        <form autocomplete="off" @submit.prevent="submit" v-if="detraction">
            <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <el-input-number v-model="detraction.reference_value_service" :precision="2" :step="1" :min="0.01" @change="changeAmountDetraction"></el-input-number>
                                </div>
                            </div>
                ...
                <div class="form-actions text-right mt-4">
                    <el-button class="second-buton" @click.prevent="clickCancel()">Cancelar</el-button>
...
<script>
    ...
    export default {
        props: ['showDialog', 'detraction','total', 'currencyTypeIdActive', 'operationTypeId', 'exchangeRateSale', 'isUpdateDocument', 'detractionDecimalQuantity','configuration'],
        data() {
            return {
        ...
        methods: {
            ...
            changeAmountDetraction(){
                ...
                if(_.round(this.detraction.reference_value_service*(parseFloat(this.detraction.percentage) / 100), round)> this.detraction.amount ){
                    ...
                    this.detraction.amount = this.detraction_invoice_amount
                }
            },
        }
    }
