    ...
    <div>
        <el-dialog :title="titleDialog" :visible="show" @open="create" width="50%"
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group" :class="{'has-danger': errors.payment_condition_id}">
                        ...
                        <el-select v-model="document.payment_condition_id" @change="changePaymentCondition" popper-class="el-select-document_type" dusk="document_type_id">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button class="submit" type="primary" @click="submit" :disabled="!dateValid" :loading="loading_submit" v-if="flag_generate">Generar</el-button>
            </span>
