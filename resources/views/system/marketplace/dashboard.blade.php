...
<div class="container-fluid py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="{{ route('system.marketplace.products_analytics') }}" class="btn btn-outline-primary btn-sm">📈 Analítica de productos</a>
    ...
    {{-- ════════════ 1. KPIs PRINCIPALES — agrupados por área ════════════
         Orden lógico: salud (tiendas/listings) → actividad (tráfico/leads)
         → resultado (pedidos/revenue). Cada par de KPIs usa el mismo color
         de borde para reforzar el agrupamiento visual. --}}
    <div class="mpd-section-label">📋 Resumen general</div>
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-2">
            <div class="card p-3 border-info">
                <small class="text-info">👁️ Tráfico</small>
    ...
    {{-- ════════════ 2. CONVERSIÓN — funnel + estado de salud ════════════ --}}
    <div class="mpd-section-label">🎯 Conversión y salud</div>
    <div class="row g-3 mb-4">
        <div class="col-md-6">
            <div class="card p-3 h-100">
                <h5 class="mb-3">Funnel global</h5>
                <div id="mpFunnel"></div>
                <small class="text-muted d-block mt-3">
                    Vistas → Clicks → Leads → Pedidos. % indica conversión desde el total de vistas.
                </small>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="mpd-section-label">📈 Tendencia (30 días)</div>
    <div class="card mb-4 p-3">
        ...
        @endphp
        @if($isEmpty)
            <div class="text-center text-muted py-4">No hay actividad aún en los últimos 30 días</div>
        @else
    ...
    <div class="mpd-section-label">🏪 Rendimiento por tienda</div>
    <div class="row g-3 mb-4">
        <div class="col-md-6">
            <div class="card p-3 h-100">
                <h5 class="mb-3">Top tiendas — por leads</h5>
    ...
    {{-- ════════════ 5. RENDIMIENTO POR PRODUCTO / CATEGORÍA ════════════ --}}
    <div class="mpd-section-label">🔥 Rendimiento por producto y categoría</div>
    <div class="row g-3 mb-4">
        <div class="col-md-6">
            <div class="card p-3 h-100">
        ...
        <div class="col-md-6">
            <div class="card p-3 h-100">
                <h5 class="mb-3">Categorías más populares</h5>
...
/* Labels de sección — separadores narrativos entre bloques temáticos */
.mpd-section-label {
    font-size: 11.5px;
    font-weight: 700;
