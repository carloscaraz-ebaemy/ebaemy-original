...
<div class="urban-footer">
    <div class="urban-footer__grid">
        ...
        <div><h4 class="urban-footer__title">Ayuda</h4><ul class="urban-footer__links"><li><a href="{{ route('tenant.terminos_condiciones') }}">Términos</a></li><li><a href="{{ route('tenant.cambios_devolucion') }}">Cambios</a></li><li><a href="{{ route('tenant.politica_envio') }}">Envíos</a></li><li><a href="{{ route('tenant.libro_reclamaciones') }}" class="ec-claims-link">Libro de Reclamaciones</a></li></ul></div>
