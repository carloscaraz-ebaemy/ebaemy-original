...
<div class="hw-footer">
    <div class="hw-footer__grid">
        ...
        <div><h4 class="hw-footer__title">Servicio</h4><ul class="hw-footer__links"><li><a href="{{ route('tenant.terminos_condiciones') }}">Términos</a></li><li><a href="{{ route('tenant.cambios_devolucion') }}">Devoluciones</a></li><li><a href="{{ route('tenant.politica_envio') }}">Envíos</a></li><li><a href="{{ route('tenant.libro_reclamaciones') }}" class="ec-claims-link">Libro de Reclamaciones</a></li></ul></div>
