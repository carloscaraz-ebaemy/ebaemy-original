...
<div class="pharma-footer">
    <div class="pharma-footer__grid">
        ...
        <div><h4 class="pharma-footer__title">Legal</h4><ul class="pharma-footer__links"><li><a href="{{ route('tenant.terminos_condiciones') }}">Términos</a></li><li><a href="{{ route('tenant.politica_privacidad') }}">Privacidad</a></li><li><a href="{{ route('tenant.politica_envio') }}">Envíos</a></li><li><a href="{{ route('tenant.libro_reclamaciones') }}" class="ec-claims-link">Libro de Reclamaciones</a></li></ul></div>
