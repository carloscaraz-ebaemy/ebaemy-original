    ...
    <div class="mp-detail-info">
        ...
        @if($listing->stock > 0)
            ...
            @if(!empty($listing->seller_whatsapp))
                ...
                @endphp
                {{-- Mismo botón verde de WhatsApp que la tienda ecommerce
                     (.ropa-btn-whatsapp): sólido #25d366, va directo a wa.me
                     con el producto pre-cargado. --}}
                <a href="{{ $waUrl }}" target="_blank" rel="noopener nofollow"
                   class="mp-cta-whatsapp"
