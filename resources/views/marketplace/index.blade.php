...
@if(isset($dailyOffers) && $dailyOffers->count() >= 4 && empty($onOfferOnly))
    ...
    @include('marketplace.partials.daily-offers', [
        ...
        'modalSeenKey' => 'mp_offers_modal_seen',
        'offersSub'    => 'Descuentos vigentes de ' . $offerTenantsCount . ' tienda' . ($offerTenantsCount === 1 ? '' : 's') . ' verificada' . ($offerTenantsCount === 1 ? '' : 's') . '. Aprovecha mientras duren.',
    ])
@endif
...
{{-- El bottom sheet del detalle del producto ahora vive en
     marketplace.partials.product-sheet, incluido por layout.blade.php.
     Funciona en TODAS las vistas con cards sin duplicacin. --}}
...
// El JS del bottom sheet del producto vive en
// marketplace.partials.product-sheet (incluido por layout.blade.php)
// para que funcione en todas las vistas con cards sin duplicacin.
</script>
@push('styles')
<style>
