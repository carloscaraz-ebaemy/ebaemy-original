...
if ($hostname) {
    ...
    Route::domain($app_url)->group(function () {
        ...
        Route::get('marketplace/account/coupons/count',   'MarketplaceAuthController@accountCouponsCount')->name('marketplace.account.coupons.count');
        ...
        Route::middleware('auth:admin')->group(function () {
            ...
            Route::prefix('admin/marketplace')->name('system.marketplace.')->group(function () {
                ...
                Route::get('products-analytics',      'System\MarketplaceAdminController@productsAnalytics')->name('products_analytics');
