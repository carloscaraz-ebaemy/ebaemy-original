                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 text-start mt-3 mb-0">
                            <address class="ib me-2">
                                ...
                                <span v-if="establishment.district">{{ establishment.district.description }},</span>
                                <span v-if="establishment.province">{{ establishment.province.description }},</span>
                                <span v-if="establishment.department">{{ establishment.department.description }}</span>
                                <span v-if="establishment.country"> - {{ establishment.country.description }}</span>
                                <br>
                            ...
                            <div class="col-lg-4 pb-2">
                                <div class="form-group" :class="{'has-danger': errors.devolution_reason_id}">
                                    ...
                                    <el-select v-model="form.devolution_reason_id" filterable
                                        ...
                                        <el-option v-for="option in devolution_reasons" :key="option.id"
                                                   :value="option.id" :label="option.description"></el-option>
                                    </el-select>
                                    <small class="form-control-feedback" v-if="errors.devolution_reason_id"
                                           v-text="errors.devolution_reason_id[0]"></small>
                                </div>
                            </div>
                            <div class="col-lg-2">
