...
Route::middleware(['check.permission', 'locked.tenant', 'check.email.verified', 'set.theme'])->prefix('ecommerce')->group(function () {
    ...
    Route::middleware(['auth', 'redirect.module'])->group(function () {
        ...
        Route::get('home_content', 'ConfigurationController@home_content');
        Route::post('home_content', 'ConfigurationController@store_home_content');
        Route::post('home_content/brand-logo', 'ConfigurationController@upload_brand_logo');
        Route::get('card_options', 'ConfigurationController@card_options');
        Route::post('card_options', 'ConfigurationController@store_card_options');
        Route::get('home_sections', 'ConfigurationController@home_sections');
        Route::post('home_sections', 'ConfigurationController@store_home_sections');
    ...
    Route::middleware('auth')->group(function () {
        ...
        // Homologación de marcas ERP → Saga
        Route::get('marketplace/channels/{channelId}/saga-brands', '\App\Http\Controllers\Tenant\MarketplaceController@sagaBrands');
        Route::post('marketplace/channels/{channelId}/saga-brands', '\App\Http\Controllers\Tenant\MarketplaceController@saveSagaBrand');
        // Atributos obligatorios por producto
        Route::get('marketplace/channels/{channelId}/products/{productId}/attributes', '\App\Http\Controllers\Tenant\MarketplaceController@productAttributes');
        Route::post('marketplace/channels/{channelId}/products/{productId}/attributes', '\App\Http\Controllers\Tenant\MarketplaceController@saveProductAttributes');
        // Despacho de pedidos
