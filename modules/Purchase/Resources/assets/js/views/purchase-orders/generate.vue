                                                ...
                                                <div class="input-group input-group-sm mb-2">
                                                    <div v-if="currency_type.symbol" class="input-group-prepend">
                                                        <span class="input-group-text"
                                                              id="basic-addon1">{{ currency_type.symbol }}</span>
                                                    </div>
                                                    <input v-model="row.unit_price" @change="inputUnitPrice(index)"
                                                           type="number" min="0" step='0.01' class="form-control"
                                                           aria-label="Precio Unitario" aria-describedby="basic-addon1">
                                                </div>
                                            </td>
